 ...
 * Use the {@link SellerAccountInfo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SellerAccountInfo extends Fragment {
    ...
    Button logout;
    TextView profilepage,role,personname;
     ...
     * @return A new instance of fragment SellerAccountInfo.
     */
    // TODO: Rename and change types and number of parameters
    public static SellerAccountInfo newInstance(String param1, String param2) {
        SellerAccountInfo fragment = new SellerAccountInfo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_seller_account_info, container, false);
        profilepic=v.findViewById(R.id.profile_picture);
        fab=v.findViewById(R.id.floatingActionButton);
        logout=v.findViewById(R.id.signup);
        ...
        if (resultCode == Activity.RESULT_OK)
            ...
            switch (requestCode){
                case GALLERY_REQUEST:
                    ...
                    final StorageReference reference=storage.getReference().child("seller").child("profile").child(u.getUid());
